<?php include('session.php');
	...
	error_reporting(0);
    if($_GET['edit']=="yes"){
        $sqll="select * from projects where fld_id='".$_GET['id']."' limit 1";
	...
	if(isset($_REQUEST['delete'])) {   
	    $id=$_GET['delete'];
	    $del_query=mysql_query("select * from projects where fld_id='$id'");
	    $del_row = mysql_fetch_array($del_query);
	    mysql_query("delete from projects where fld_id='$id'");
	    if(file_exists("../img_201415/project/$del_row[fld_img]")){
	    unlink("../img_201415/project/$del_row[fld_img]");
	    header("location: projects.php?confirm=Image Deleted");
	    }
	}
?>
<?php
	if(isset($_REQUEST['submitt']) && isset($_POST['Upload'])){
        ...
        if ($_FILES["file"]["error"] > 0){
          echo "Error: " . $_FILES["file"]["error"] . "<br />";
			...
			$insert=mysql_query("insert into projects (fld_title,fld_desc,fld_img) values ('$texttitle','$textdetails','$file')") or die(mysql_error());		  		
			if($insert){
        		header("location:projects.php?msg=Image Uploaded Successfully!");
        	}
	}  
?>
<?php
	if(isset($_REQUEST['submitted']) && $_GET['edit'] == "yes"){
		...
		$sql = mysql_query("update projects set fld_title = '$texttitle', fld_desc = '$textdetails', fld_img = '$file' where fld_id = '$id'")or die(mysql_error());
?>
<script type="text/javascript">
 window.location ="projects.php?id=<?php echo $id;?>&edit=<?php echo $yes;?>&confirm=Image Updated!";
</script>			
<?php } ?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">Project Image Gallery</a></li>
						</ul>
                                   ...
                                   <form role="form"  method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<div class="form-actions">
											 <?php if(empty($_GET['edit']) == "yes"){ ?>  
												<button type="submit"  name="Upload" class="btn green">Upload</button>
				...
				<div class="row-fluid">
					<div class="span12">               
							<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption"><i class="icon-picture"></i>Projects Description
	                       ...
	                       <?php
                            	...
                            	$listresult=mysql_query("select * from projects order by fld_id desc");
	                        ...
	                        ?>										
												<tr>
													...
													<td>
													<?php if($row['fld_img']){ ?>
														<img src="../img_201415/project/<?php echo "$row[fld_img]";?>" width="35" height="35" >
													<?php } else { ?>
														 <img src="../img_201415/project/no_image.jpg" width="35" height="35" >
													<?php } ?>	 
													</td>
													<td><a href ='projects.php?id=<?php echo "$row[fld_id]";?>&edit=yes' title='Edit'>Edit</a></td>
													<td><a href="projects.php?delete=<?php echo "$row[fld_id]";?>" class="btn mini red"><i class="icon-trash"></i> Delete</a></td>
												</tr>
	 						<?php } ?>
											</tbody>
										</table>
