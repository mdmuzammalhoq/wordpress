...
if(isset($_POST['submit'])){
	...
	$result=mysql_query("select * from users_list where fld_username='$username' && fld_password='$password'");
	...
	<?php
		...
		$_SESSION['name'] = $detail['fld_name'];
		$_SESSION['email'] = $detail['fld_email'];
